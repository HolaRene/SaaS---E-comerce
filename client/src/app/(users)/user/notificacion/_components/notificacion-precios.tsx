    ...
    return (
        <ScrollArea className="h-[600px] pr-4">
            <div className="space-y-3">
                {filterNotifications("price").length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-muted-foreground">No hay cambios de precio</p>
                    </div>
                )}
            </div>
        </ScrollArea>
...
export default Notificacionprecios