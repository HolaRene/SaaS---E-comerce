                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input id="nit" defaultValue="J0310000123456" className="pl-10" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <FileText className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                            <Input id="ruc" defaultValue="123-456789-0001A" className="pl-10" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input id="direccion-fiscal" defaultValue="Boaco, del parque central 1c. al este." className="pl-10" />
                        </div>
                    </div>
                </CardContent>
            </Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-4">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Último respaldo: 05/10/2025, 11:30 AM</p>
                        </div>
